...
!(function(p) {
          ...
          for (var t in e.data)
            i.$this.append(
              '<li><a href="' +
                e.data[t].link +
                '" ><img src="' +
                e.data[t].images.standard_resolution.url +
                '"></a></li>'
            );
        },
        error: function(e) {
    ...
    (p.fn.myGradientChart = function(e) {
      ...
      return this.easyPieChart({
        barColor: function(e) {
          ...
          return (
            a.addColorStop(0, o.barColor1), a.addColorStop(1, o.barColor2), a
          );
        },
  ...
  if (
    ...
    (p.fn.mySelect = function(e) {
      ...
      a.on("click", function(e) {
        ...
        s.on("click", function(e) {
          e.stopPropagation(),
            a.text(p(this).text()).removeClass("active"),
            t.val(p(this).attr("rel")),
            o.hide(),
            p(this)
              .parent()
              .parent()
    ...
    (p.fn.customNumber = function(e) {
      ...
      return (
        this.append('<span class="add">' + t.plusIcon + "</span>"),
        this.append('<span class="sub">' + t.minusIcon + "</span>"),
        this.each(function() {
          var e = p(this),
    ...
    (p.fn.onScreen = function() {
      ...
      return (
        (t.right = t.left + p(window).width()),
        (t.bottom = t.top + p(window).height()),
    ...
    p(window).on("load", function() {
      ...
      if ((m(), y(), h(), v(), g(), 0 < p(".cases-grid, .blog-grid").length)) {
          ...
          e = function() {
            ...
            return (
              1200 < e
                ...
                : 385 < e && (t = 1),
              (o = Math.floor(e / t)),
              n.find(".grid-item").each(function() {
                var e = p(this),
        ...
        (r = function() {
          ...
          p(".filter-button-wraper .option-set")
            .find("a")
            .on("click", function() {
              var e = p(this),
              ...
              return (
                (o = "false" !== o && o),
                (i[a] = o),
                "layoutMode" === a && "function" == typeof changeLayoutMode
        ...
        e = function() {
          ...
          return (
            1200 < e
              ...
              : 385 < e && (t = 1),
            (o = Math.floor(e / t)),
            i.find(".portfolio-grid-item").each(function() {
              var e = p(this),
      ...
      if (0 < p(".portfolio-grid-loadmore").length) {
        var t = function(e) {
            ...
            var t = s.filteredItems
              .slice(e, s.filteredItems.length)
              .map(function(e) {
                return e.element;
              });
            p(t).addClass("hidden"),
        ...
        e = function() {
          ...
          return (
            1200 < e
              ...
              : 385 < e && (t = 1),
            (o = Math.floor(e / t)),
            a.find(".portfolio-grid-item").each(function() {
              var e = p(this),
                t = e.attr("class").match(/portfolio-grid-item-w(\d)/),
                i = e.attr("class").match(/portfolio-grid-item-h(\d)/),
                a = t ? o * t[1] : o;
        ...
        t(c),
          a.after(
            '<div class="text-center"><a href="#" id="load-more" class="loadmore-btn"><i class="icon icon-plus"></i> Load More</a></div>'
          ),
          p("#load-more").on("click", function(e) {
            e.preventDefault(),
              p("#filters").data("clicked")
                ? ((o = c), j$("#filters").data("clicked", !1))
                : (o = o),
              t((o += c));
          });
      }
        ...
        e = function() {
          ...
          return (
            1200 < e
              ...
              : 385 < e && (t = 1),
            (o = Math.floor(e / t)),
            d.find(".portfolio-grid-item").each(function() {
              var e = p(this),
                t = e.attr("class").match(/portfolio-grid-item-w(\d)/),
                i = e.attr("class").match(/portfolio-grid-item-h(\d)/),
                a = t ? o * t[1] : o;
      ...
      0 < p(".agency-portfolio-slider").length &&
        p(".agency-portfolio-slider").myOwl({
          items: 5,
          nav: !1,
          responsive: {
            0: {
    ...
    p(document).ready(function() {
      ...
      m(),
        ...
        p(document).on("submit", "#xs-contact-form", function(e) {
          ...
          if ((p(".xpeedStudio_success_message").remove(), 0 < i.length)) {
            if ("" === i.val().trim())
              return i.addClass("invaild"), (d = !0), i.focus(), !1;
            i.removeClass("invaild");
          }
          if (0 < a.length) {
            if ("" === a.val().trim())
              return a.addClass("invaild"), (d = !0), a.focus(), !1;
            a.removeClass("invaild");
          }
          if (0 < o.length) {
            if ("" === o.val().trim())
              return o.addClass("invaild"), (d = !0), o.focus(), !1;
            o.removeClass("invaild");
          }
          if (0 < n.length) {
            if ("" === n.val().trim())
              return n.addClass("invaild"), (d = !0), n.focus(), !1;
            if (
              ((t = n.val().toLowerCase()),
          ...
          if (0 < s.length) {
            if ("" === s.val().trim())
              return s.addClass("invaild"), (d = !0), s.focus(), !1;
            s.removeClass("invaild");
          }
          if (0 < r.length) {
            if ("" === r.val().trim())
              return r.addClass("invaild"), (d = !0), r.focus(), !1;
          ...
          !1 === d &&
            ...
            p.ajax({
              ...
              success: function(e) {
                l
                  .after('<p class="xpeedStudio_success_message">' + e + "</p>")
                  .hide()
                  .fadeIn(),
                  setTimeout(function() {
        ...
        0 < p(".offset-side-bar").length &&
          p(".offset-side-bar").on("click", function(e) {
            e.preventDefault(),
              e.stopPropagation(),
              p(".cart-group").addClass("isActive");
          }),
        ...
        0 < p(".insta-feed").length &&
          p(".insta-feed").instaFeed({
            token: "2367672995.1677ed0.dea7a14501d04cd9982c7a0d23c716dd",
            photos: 6
          }),
        0 < p(".insta-feed2").length &&
          p(".insta-feed2").instaFeed({
            token: "2367672995.1677ed0.dea7a14501d04cd9982c7a0d23c716dd",
            photos: 8
          }),
        0 < p(".xs-modal-popup").length &&
          p(".xs-modal-popup").magnificPopup({
            type: "inline",
            fixedContentPos: !1,
            fixedBgPos: !0,
            overflowY: "auto",
        ...
        0 < p("img").length &&
          p("img").each(function() {
            p(this).attr("draggable", "false"),
              p(this).on("mousedown", function(e) {
                e.preventDefault && e.preventDefault();
              });
          }),
        0 < p(".agency-office-slider").length &&
          p(".agency-office-slider").myOwl({
            items: 3,
            autoWidth: !0,
            margin: 30,
            nav: !0,
        ...
        0 < p(".review-slider").length &&
          p(".review-slider").myOwl({
            nav: !0,
            navText: [
        ...
        0 < p(".client-slider").length &&
          p(".client-slider").myOwl({
            items: 5,
            responsive: {
              0: {
                items: 1
        ...
        0 < p(".subscribe-form, .my-newsletter").length &&
          p(".subscribe-form, .my-newsletter").ajaxChimp({
            url:
              "https://facebook.us8.list-manage.com/subscribe/post?u=85f515a08b87483d03fee7755&amp;id=66389dc38b"
          }),
        0 < p(".agency-team-slider").length &&
          p(".agency-team-slider").myOwl({
            items: 4,
            autoplay: !1,
            responsive: {
              0: {
        ...
        (function() {
          for (
            var e = ["#b224ef", "#0369d1", "#ff4eb6"],
              t = ["#5055fa", "#00ecbc", "#ffcb6d"],
              i = p(".chart"),
              a = p(".chart-content"),
              o = 0;
            o < p(".single-piechart").length;
            o++
          ) {
            ...
            p(a[o]).append(
              '<span class="gradient-title" style="background: linear-gradient(90deg, ' +
                e[o] +
                " 0%, " +
                t[o] +
                " 84%); color: " +
              ...
              },
              {
                ...
                step: function() {
                  e.text(Math.floor(this.value)),
                    a &&
                      e.text(
                        e.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")
                      );
                },
                complete: function() {
                  parseInt(e.text(), 10) !== i &&
                    (e.text(i),
                    a &&
                      e.text(
                        e.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")
      ...
      (0 < p(".xs-select").length && p(".xs-select").mySelect(),
      0 < p(".product-slider, .about-slider").length &&
        p(".product-slider, .about-slider").myOwl({
          dots: !0,
          responsive: {
            0: {
              dots: !1
      ...
      0 < p(".custom_number").length &&
        p(".custom_number").customNumber({
          plusIcon: '<i class="icon icon-up-arrow2"></i>',
          minusIcon: '<i class="icon icon-down-arrow2"></i>'
        }),
      0 < p(".btn-floating").length) &&
        (p(".floating-icons-list").addClass("hidden"),
        p(".btn-floating").each(function() {
      ...
      if (
        (0 < p(".rate-graph").length &&
          p(".rate-graph").each(function() {
            p(this)
              .find(".rate-graph-bar")
        ...
        0 < p(".banner-slider, .quote-slider").length &&
          p(".banner-slider, .quote-slider").myOwl({
            nav: !0,
            navText: [
        ...
        0 < p(".scrollto-button").length &&
          p(".scrollto-button").goCurrentSection(),
        0 < p(".review-slider-preview").length &&
          0 < p(".review-slider-thumb").length)
      ) {
        ...
        n
          ...
          .on("changed.owl.carousel", function(e) {
            ...
            s
              .find(".owl-item.active")
              .last()
              .index() < i && s.data("owl.carousel").to(i, 100, !0),
              i < o && s.data("owl.carousel").to(i - a, 100, !0);
          }),
          s
      ...
      if (
        0 < p(".bouble-slider-privew").length &&
        0 < p(".bouble-slider-thumb").length
      ) {
        (n = p(".bouble-slider-privew")),
          (s = p(".bouble-slider-thumb")),
          (r = 5),
          (l = !0);
        n
          .owlCarousel({
      ...
      if (
        (0 < p(".single-page-menu li a").length &&
          (p(".single-page-menu li a").on("click", function() {
            if (
              ...
              var e = p(this.hash);
              if (
                (e = e.length ? e : p("[name=" + this.hash.slice(1) + "]"))
                  .length
              )
                return (
                  p("html,body").animate(
          ...
          p(".single-page-menu li a").on("click", function() {
            ...
            t.hasClass("nav-menus-wrapper-open") &&
              t.removeClass("nav-menus-wrapper-open"),
              "block" === e.css("display") && e.css("display", "none"),
              p(".offcanvas-menu-wraper").hasClass("active") &&
                p(".offcanvas-menu-wraper").removeClass("active"),
              p(".fullscreen_menu_tigger").hasClass("open") &&
                p(".fullscreen_menu_tigger").removeClass("open"),
              p(".off-canvas-menu-area").hasClass("nav-is-open") &&
                p(".off-canvas-menu-area").removeClass("nav-is-open");
          })),
        0 < p(".typed").length)
      )
        new Typed(".typed", {
      ...
      if (0 < p(".input-material").length) {
        for (
          var d = p(".input-material .form-control"), c = 0;
          c < d.length;
          c++
        )
          p(d[c]).wrap('<div class="form-group"></div>'),
            p(d[c]).after('<span class="bar"></span>');
        p(d).each(function(e, t) {
          var i = p(t).attr("placeholder");
          p(t).after('<span class="placeholder-title">' + i + "</span>"),
            p(t).removeAttr("placeholder");
        }),
      ...
      0 < p("#cal_to_action_animation").length &&
        p("#cal_to_action_animation").parallax(),
        0 < p(".xs-map-popup").length &&
          p(".xs-map-popup").magnificPopup({
            disableOn: 700,
            type: "iframe",
            mainClass: "mfp-fade",
            removalDelay: 160,
    ...
    p(window).on("scroll", function() {
      0 < p(".shuffle-letter-title-wraper").length &&
        p(".shuffle-letter-title-wraper").each(function(e) {
          p(this).onScreen() &&
            !p(this).hasClass("shuffle-title") &&
            setTimeout(
              function() {
                p(this)
                  .find(".shuufle-letter-title")
                  .shuffleLetters(),
                  p(this).addClass("shuffle-title");
              }.bind(this),
              400
            );
        });
