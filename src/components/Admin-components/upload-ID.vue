        ...
        <div class="modal-container">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="alert-contain" v-if="uploading && progress < 100">
                <div class="mt-4 mb-4 modal-top-text text-center">
                  Uploading ID
                </div>
                <div class="progress">
              ...
              <div class="alert-contain" v-if="uploading && progress == 100">
                <div class="mt-4 mb-4 modal-info-text text-center">
                  ID uploaded successfully. We will review and send a
                  confirmation if ID is valid
                </div>
                <div class="progress">
                  <div
                    v-bind:class="{ prgsuccess: progress == 100 }"
                    class="progress-bar"
                    role="progressbar"
                    :style="{ width: progress + '%' }"
                    :aria-valuenow="progress"
