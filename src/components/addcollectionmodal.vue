          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="alert-contain">
                <p class="text-inside text-center" :caption="caption">
                  {{ caption }}
                </p>
                ...
                <div class="text-center mb-3 mt-4">
                  ...
                  <button
                    @click="handleSubmit"
                    style="border-radius: 5px !important;padding: 0 30px !important;"
                ...
                <p class="text-center peexo-body-text">
                  Tip:
                  <router-link class="peexo-highlight-text" to="/subscribe">
                    Subscribe</router-link
                  >
                  for FindmyFace, and download unlimited events
                </p>
              </div>
            </div>
          </div>
